...
trait HasRole
{
	...
	*/
	 ...
	 * @return Builder
	 */
	public function scopeRole(Builder $query, $role, string $column = null)
	{
		if (is_null($role)) {
			return $query;
		}
	 ...
	 * @return bool
	 */
	public function hasRole(string $slug, $operator = null): bool
	{
		$operator = is_null($operator) ? $this->parseOperator($slug) : $operator;
		
		$roles = $this->getRoles();
		$roles = $roles instanceof Arrayable ? $roles->toArray() : $roles;
	...
	*/
	 ...
	 * @return bool
	 */
	protected function isWithAnd($slug, $roles): bool
	{
